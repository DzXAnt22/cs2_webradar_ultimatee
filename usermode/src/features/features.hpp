...
namespace hashes
{
    ...
    const auto PLANTED_C4_DESIGNER = fnv1a::hash_const("planted_c4");
    const auto SMOKE_DESIGNER = fnv1a::hash_const("smokegrenade_projectile");
    const auto INFERNO_DESIGNER = fnv1a::hash_const("inferno");
    const auto HE_DESIGNER = fnv1a::hash_const("hegrenade_projectile");
